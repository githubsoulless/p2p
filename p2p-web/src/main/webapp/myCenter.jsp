        ...
        <div class="allInvest clearfix">
                 ...
                 <dl>
                     <dt>
                         ...
                         <span class="profit">投资时间</span>
                            ...
                            <c:forEach items="${recentBidInfoVOList}" var="bidInfo" varStatus="index">
                                <dd>

                                    <span class="name">${index.count}</span>
                                    <span id="preparedLoanTotalLoanCount" class="number">${bidInfo.productName}</span>
                    ...
                    <c:choose>
                        <c:when test="${not empty recentBidInfoVOList}">
            ...
            <div class="eachInvest invest-tab invest-tab-box">
                ...
                <dl>
                    ...
                    <c:forEach items="${rechargeRecordList}" var="recharge" varStatus="index">
                        <dd>
                            <span class="name">${index.count}</span>
                            <span id="preparedLoanStandardTotalLoanCount" class="number">${recharge.rechargeDesc}</span>
                            <span id="preparedLoanStandardTotalBidMoney" class="money">${recharge.rechargeMoney}</span>
                            <span id="preparedLoanStandardTotalIncome" class="profit"><fmt:formatDate value="${recharge.rechargeTime}" pattern="yyyy-MM-dd HH:mm:ss"/> </span>
                        </dd>
                    </c:forEach>
            ...
            <div class="eachInvest recent-earnings">
                ...
                <dl id="recentearning">
                    ...
                    <c:forEach items="${incomeRecordList}" var="income" varStatus="index">
                        <dd>
                            <span class="number" style="text-align:left;">${index.count}</span>
                            <span id="preparedLoanStandardTotalLoanCount" class="number">${income.loanInfo.productName}</span>
                            <span id="preparedLoanStandardTotalIncome" class="number name" style="text-align:center;"><fmt:formatDate value="${income.incomeDate}" pattern="yyyy-MM-dd"/> </span>
                            <span id="preparedLoanStandardTotalBidMoney" class="profit">${income.loanInfo.rate}</span>
                ...
                <div id="moreRecentIncome" class="more-allinvest">
                    <a href="${pageContext.request.contextPath}/loan/myInvest"><span>查看全部收益计划</span><i></i></a>
                </div>
            </div>
        </div>
        <!--最新操作数据end-->
