        ...
        <c:choose>
            ...
            <c:when test="${empty user}">
                <div class="register">
                    ...
                    <div class="bn_register"><a href="${pageContext.request.contextPath}/register.jsp" class="btn-1">免费注册</a></div>
                    <div class="login">有账号? <a href="${pageContext.request.contextPath}/login.jsp">立即登录</a></div>
                </div>
            </c:when>
            <c:otherwise>
                <div class="register welcome">
                    <div class="welcome-txt">欢迎 <span>“<b>${user.phone}</b>”</span><br/>来动力金融网投资！</div>
                    <div class="bn_register"><a href="loan/myCenters" class="btn-1">进入我的小金库</a></div>
                </div>
            </c:otherwise>
        </c:choose>
...
<div id="productArea">
	...
	<div class="mainBox pro-body clearfix">
		...
		<!-- 1:已满标时class样式追加 pro-full-->
			<div class="pro-box pro-full <c:if test='${uLoanInfo.leftProductMoney==0}'>pro-full</c:if>" </div>
			<div class="pro-top">
	...
	<div class="mainBox pro-body disperse-pro clearfix">
		  ...
		  <c:forEach items="${sLoanInfoList}" var="sLoanInfo">
		<!-- 1:已满标时追加pro-full-->
